...
theme.font                                      = "Inconsolata Bold for Powerline 10"
-- theme.font                                      = "xos4 Terminus 12"
theme.fg_normal                                 = "#FEFEFE"
theme.fg_focus                                  = "#CB755B"
     ...
     --       wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), theme.bg_focus),
      --      arrow(theme.bg_normal, "#343434"),
       --     wibox.container.background(wibox.container.margin(task, 3, 7), "#343434"),
            ...
            arrow("#C0C0A2", "#777E76"),
            wibox.container.background(clock, "#777E76"),
            --wibox.container.background(wibox.container.margin(wibox.widget { clockicon, clock.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#777E76"),
